...
export default function MonitoringPage() {
  ...
  return <div className="mx-auto w-full max-w-6xl space-y-6">
    <div><p className="text-sm text-muted-foreground">Infrastructure / Monitoring</p><h1 className="mt-1 text-2xl font-semibold tracking-tight">Monitoring</h1><p className="mt-1 text-sm text-muted-foreground">Health and resource usage across your infrastructure.</p></div>
