...
import { Cpu, HardDrive, KeyRound, MemoryStick, Plus, Server as ServerIcon } from "lucide-react";
...
export default function ServersPage() {
  ...
  return <div className="mx-auto w-full max-w-6xl space-y-6">
    <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div><p className="text-sm text-muted-foreground">Infrastructure / Servers</p><h1 className="mt-1 text-2xl font-semibold tracking-tight">Servers</h1><p className="mt-1 text-sm text-muted-foreground">Monitor the machines running your applications.</p></div>
