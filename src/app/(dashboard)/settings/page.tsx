...
export default function SettingsPage() {
  ...
  return <div className="mx-auto w-full max-w-3xl space-y-6">
    <div><p className="text-sm text-muted-foreground">Settings / Instance</p><h1 className="mt-1 text-2xl font-semibold tracking-tight">Settings</h1><p className="mt-1 text-sm text-muted-foreground">Configure this Hefesto instance and your dashboard preferences.</p></div>
