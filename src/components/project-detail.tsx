...
export function ProjectDetail({ project }: { project: Project }) {
  ...
  return <div className="fixed inset-0 z-10 overflow-hidden">
    ...
    <ProjectCanvas project={project} applications={apps} services={services} templates={mockServiceTemplates} domains={mockDomains} deployments={deployments} bindings={mockBindings} activeApplicationIds={activeApplicationIds} addOpen={addOpen} onAddOpenChange={setAddOpen} />
